...
const MainContent = (
  ...
  return (
    ...
    <LinkToOnline url={url}/>
      <Card onClick={() => onTeacherClick(teacher)} style={{marginTop: "1em"}}>
          <CardContent >
      ...
      <Card  style={{marginTop: "1em"}}>
        ...
        content={
            <TextBox >
       <Body1 style={{marginLeft:"0.5em"}}>Корпус {room[0]}</Body1>
       <TextBoxLabel style={{color: "grey", marginLeft:"0.5em"}}>
      Кабинет {parseInt(room.replace(/[^\d]/g, ''))}
      </TextBoxLabel>
      </TextBox>
        }
...
const LessonCard = (
  ...
  return <Cell style={{margin: "0 1em 1em 1em"}}
    content={
      <MainContent
