...
class Dashboard extends React.Component {
  ...
  render() {
      console.log(this.props.state.today, "day");
      ...
      <DocStyle/>
      {
        ...
        <Row>
          <TextBox style={{ marginLeft: "3em", paddingTop: "0.5em"}}>
              {this.props.state.today===0 ?  (<CardParagraph2 style={{fontSize: "20px"}}>
              Выходной😋
               </CardParagraph2>
               ) : (
            ...
            <CardParagraph1 style={{color: "var(--plasma-colors-white-secondary)"}}>
              Сегодня {this.Para(this.props.state.day[this.props.state.today-1].count[0])} с {this.getTimeFirstLesson(this.props.state.today-1+1)[0].slice(0,5)} до {this.getEndLastLesson("this.props.state.today-1")}
            </CardParagraph1>) : (<CardParagraph1 style={{color: "var(--plasma-colors-white-secondary)"}}>
              Сегодня пар нет
            </CardParagraph1>)
          }
          </TextBox>
        ...
        {this.props.getCurrentLesson(new Date(Date.now()   )) !== undefined ? (
          ...
          <TextBox  style={{color: "var(--plasma-colors-white-secondary)"}}>
            ...
            <TextBox>   
                ...
                {this.props.state.student===false&&this.props.state.teacher_correct===true ? (<TextBoxTitle> {this.props.state.days[this.props.state.this.props.state.today-1-1][`bell_${this.props.getCurrentLesson(new Date(Date.now()   ))(new Date(Date.now()   ))}`][0][7]} </TextBoxTitle>)
                :( <a onClick={()=>{this.isCorrectTeacher()}}> {this.props.state.days[this.props.state.this.props.state.today-1-1][`bell_${this.props.getCurrentLesson(new Date(Date.now()   ))(new Date(Date.now()   ))}`][0][1]} </a>) }
                ...
                <a href={this.props.state.days[this.props.state.this.props.state.today-1-1][`bell_${this.props.getCurrentLesson(new Date(Date.now()   ))(new Date(Date.now()   ))}`][0][6]} style={{color:"var(--plasma-colors-white-secondary)"}}>Ссылка на онлайн-конференцию</a>):(<div></div>)
            }
                </TextBox>
              }   
              ...
              contentRight={
                <TextBox>
              <Badge text={this.props.state.days[this.props.state.this.props.state.today-1-1][`bell_${this.props.getCurrentLesson(new Date(Date.now()   ))(new Date(Date.now()   ))}`][0][2]} contentLeft={<IconLocation size="xs"/>} 
            ...
            <Badge text={this.props.state.days[this.props.state.this.props.state.today-1-1][`bell_${this.props.getCurrentLesson(new Date(Date.now()   ))(new Date(Date.now()   ))}`][0][5][0]}  view="primary" style={{ marginRight:"0.5em" }} size="l"/>) : (<div></div>)
             }
             ></CellListItem>
             </CardContent>
  </CardBody>) : ( 
  ...
  } 
  {
    this.props.whatLesson(new Date(Date.now()   ), "next").num!== undefined ? (
      ...
      <TextBox>   
          ...
          {this.props.state.student===false&&this.props.state.teacher_correct===true ? (<TextBoxTitle> {this.props.state.days[this.props.state.this.props.state.today-1-1][`bell_${this.props.whatLesson(new Date(Date.now()   ), "next").num}`][0][7]} </TextBoxTitle>)
          :( <a onClick={()=>{this.isCorrectTeacher()}}> {this.props.state.days[this.props.state.this.props.state.today-1-1][`bell_${this.props.whatLesson(new Date(Date.now()   ), "next").num}`][0][1]} </a>) }
          ...
          <a href={this.props.state.days[this.props.state.this.props.state.today-1-1][`bell_${this.props.whatLesson(new Date(Date.now()   ), "next").num}`][0][6]} style={{color:"var(--plasma-colors-white-secondary)"}}>Ссылка на онлайн-конференцию</a>):(<div></div>)
      }
          </TextBox>
        }   
        ...
        contentRight={
          <TextBox>
        <Badge text={this.props.state.days[this.props.state.this.props.state.today-1-1][`bell_${this.props.whatLesson(new Date(Date.now()   ), "next").num}`][0][2]} contentLeft={<IconLocation size="xs"/>} 
        style={{backgroundColor: "rgba(0,0,0, 0)" }}/>
      ...
      <Badge text={this.props.state.days[this.props.state.this.props.state.today-1-1][`bell_${this.props.whatLesson(new Date(Date.now()   ), "now").num}`][0][5][0]}  view="primary" style={{ marginRight:"0.5em" }} size="l"/>) : (<div></div>)
       }
       ></CellListItem>   
      </CardContent>
  </CardBody>) : (<div></div>)
        ...
        <Row style={{marginLeft: "1em", marginRight: "1em"}}>
          ...
          <Col size={2}>
          <Card style={{height: "20vh", marginTop: "0.5em"}} onClick={()=>{this.setState({page: 15})}}>
          <CardBody>
          <CardContent>
          <TextBox >
            <CardHeadline3>
